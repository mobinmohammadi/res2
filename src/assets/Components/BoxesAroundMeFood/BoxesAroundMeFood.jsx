...
export default function BoxesFood({allRestorants , allComments}) {
  ...
  const {id ,city, name  ,image , discount} = allRestorants
         ...
         <div onClick={() => goToSinglePageFood()}>
           <div className=" pt-5 max-w-92 w-full  bg-white p-5 min-h-36 rounded-md">
             <div className="relative">
               {discount ? (
                 <>
                   <span className="absolute bg-[#ef4123] w-5 h-5 z-10 left-2 top-3  rounded-sm"></span>
                   <div className="absolute bg-[#ef4123] text-white z-10 left-2 top-3 pt-3 text-center pb-3  pr-2 pl-2 text-sm  rounded-full">
